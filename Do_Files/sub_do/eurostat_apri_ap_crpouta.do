...
local 	eurostat_filelist	: dir "`origdatadir'/Eurostat/apri_ap_crpouta" files "*data*"
...
foreach var of varlist `prefix'* {
	...
	* Remove some common non-numeric charactrers
	...
	replace `var' = subinstr(`var', ":", "", .)
	* will destring after keep statements
}
